...
public class LayoutVisitor implements Visitor {
	...
	public Object visitBinaryOperatorDeclaration(BinaryOperatorDeclaration ast,
			Object obj) {
		return layoutQuaternary("Bin.Op.Decl.", ast.O, ast.ARG1, ast.ARG2,
				ast.RES);
	}
	...
	public Object visitSequentialDeclaration(SequentialDeclaration ast,
			Object obj) {
	...
	private DrawingTree layoutNullary(String name) {
		...
		dt.contour.lower_head = new Polyline(0, dt.height + 2 * BORDER,
				dt.contour.lower_tail);
		return dt;
	}
	...
	private void attachParent(DrawingTree dt, int w) {
		...
		dt.contour.upper_head = new Polyline(0, dt.height, new Polyline(x1, y,
				dt.contour.upper_head));
		dt.contour.lower_head = new Polyline(0, dt.height, new Polyline(x2, y,
				dt.contour.lower_head));
	}
