...
public class DrawingTree {
	...
	public void paint(Graphics graphics) {
		...
		graphics.drawString(caption, pos.x + 2, pos.y
				+ (height + FIXED_FONT_HEIGHT) / 2);
		...
		if (parent != null) {
			graphics.drawLine(pos.x + width / 2, pos.y, parent.pos.x
					+ parent.width / 2, parent.pos.y + parent.height);
		}
	}
